  ...
  <section id="intelligence" className="py-15 px-6 relative z-20">
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row items-end justify-between mb-24 gap-8">
        <div>
          <h2 className="text-[20px] font-black uppercase tracking-[0.5em] text-[var(--brand-primary)] mb-6">Neural Feedback</h2>
        ...
        {[
          ...
          <ThreeDCard key={i}>
            <div className="flex justify-between items-start mb-10">
              <div className="p-4 rounded-2xl bg-[var(--brand-primary)]/10 border border-[var(--brand-primary)]/20 shadow-[0_0_20px_var(--brand-primary)]">
                <tier.icon className="w-8 h-8 text-[var(--brand-primary)]" />
              </div>
            ...
            <div className="flex items-center gap-3 mb-8">
              <span className="text-[10px] font-black text-[var(--brand-primary)] uppercase tracking-widest">Lvl {tier.level}</span>
              <div className="flex-1 h-1.5 bg-[var(--card-bg)] rounded-full overflow-hidden border border-[var(--card-border)]">
                <div className="h-full bg-[var(--brand-primary)] shadow-[0_0_10px_var(--brand-primary)] transition-all duration-1000" style={{ width: `${(tier.xp / tier.max) * 100}%` }} />
              </div>
            </div>
