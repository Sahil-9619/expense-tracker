    ...
    return (
        <div className="relative mx-auto flex h-full w-full flex-col items-center justify-center px-6 py-10 md:translate-y-10 lg:translate-y-16">
            <h2 className="relative z-10 mx-auto max-w-[95%] sm:max-w-2xl text-center text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black font-display tracking-tight text-white leading-[1.2] sm:leading-tight">
                ...
                <span className="relative z-20 inline-block rounded-xl bg-[var(--brand-primary)]/40 px-3 sm:px-6 py-1 text-white underline decoration-[var(--brand-primary)] decoration-[4px] sm:decoration-[6px] underline-offset-[12px] sm:underline-offset-[16px] backdrop-blur-sm">
                    future
                </span>{" "}
                today.
            </h2>
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-center gap-4">
                ...
                >
                    {/* Glass Base */}
                    <span className="pointer-events-none absolute inset-0 rounded-full bg-[var(--brand-primary)] backdrop-blur-xl border border-[var(--card-border)] transition-all duration-300 group-hover:brightness-110"></span>

                    {/* Gradient Tint */}
                    <span className="pointer-events-none absolute inset-0 rounded-full bg-gradient-to-br from-white/20 via-white/5 to-transparent opacity-30 group-hover:opacity-50 transition-all duration-300"></span>

                    {/* Shine Sweep */}
                    <span className="pointer-events-none absolute top-0 left-[-120%] h-full w-1/2 bg-white/30 blur-md transition-all duration-700 ease-out group-hover:left-[130%]"></span>
