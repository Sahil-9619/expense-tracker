      ...
      <div className="hidden md:flex flex-1 relative overflow-hidden border-r border-[var(--card-border)] group bg-[var(--bg-color)] h-full">
        ...
        <div className="relative z-20 p-8 lg:p-12 flex flex-col h-full w-full justify-center">
          <div className="max-w-md">
            ...
            >
              <div className="bg-emerald-600 p-2.5 rounded-xl shadow-[0_0_15px_rgba(16,185,129,0.3)]">
          ...
          <div className="w-full max-w-[420px] mx-auto my-auto py-8 relative">
            <div className="text-center mb-8 md:hidden">
              <motion.div
                ...
                className="inline-flex items-center justify-center bg-emerald-600 p-2 rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.3)] mb-4"
              >
              ...
              <p className="text-[var(--text-secondary)] text-[8px] font-black uppercase tracking-[0.3em] opacity-60">
            ...
            <div className="mt-8 flex items-center justify-center gap-2.5 text-[var(--text-primary)]">
              <HiOutlineShieldCheck className="w-3 h-3 opacity-40" />
