...
export default function Dashboard({ transactions = [], categoryConfig = {}, onAddClick }) {
  ...
  const cardBase = "relative rounded-xl border border-[var(--card-border)] p-4 flex flex-col bg-[var(--card-bg)] transition-all duration-200 hover:shadow-lg hover:shadow-black/20";
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-4">
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-md border border-[var(--card-border)] bg-[var(--card-bg)] text-[var(--text-primary)] hover:bg-[var(--bg-color)] transition-all">
              <Download size={12} /> Export CSV
            </button>
            <button 
              onClick={onAddClick}
              className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-md bg-emerald-600 hover:bg-emerald-500 text-white transition-all shadow-lg shadow-emerald-500/20"
            >
        ...
        <div className="grid grid-cols-12 gap-3">
          ...
          <div className={`${cardBase} col-span-12 lg:col-span-8 min-h-[220px]`}>
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-1 bg-[var(--bg-color)] p-0.5 rounded-md border border-[var(--card-border)]">
                {['1W', '1M', '3M', '1Y', 'ALL'].map(range => (
                  <button key={range} className={`text-[9px] px-2 py-1 rounded font-black uppercase tracking-widest ${range === '1M' ? 'bg-emerald-600 text-white shadow-sm' : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)]'}`}>
                    {range}
                  </button>
                ))}
              </div>
          ...
          <div className={`${cardBase} col-span-12 lg:col-span-4 min-h-[220px] flex flex-col`}>
            ...
            <div className="p-3 rounded-lg border border-[var(--card-border)] bg-[var(--bg-color)]/40 flex flex-col gap-2 mb-2">
            ...
            <div className="p-3 rounded-lg border border-[var(--card-border)] bg-[var(--bg-color)]/40 flex flex-col gap-2 mt-2">
            ...
            <div className="mt-auto flex gap-2 pt-4">
              <div className="flex-1 flex items-center px-3 py-1.5 rounded-md border border-[var(--card-border)] bg-[var(--bg-color)]/20">
              ...
              <button className="px-4 py-1.5 bg-emerald-600 text-white font-black uppercase tracking-widest text-[9px] rounded-md hover:bg-emerald-500 transition-colors shadow-lg shadow-emerald-500/10">
                Execute
              </button>
            </div>
          </div>
