        ...
        <div className="col-span-12 lg:col-span-4 space-y-4">
          <Card className="bg-[var(--card-bg)] border-[var(--card-border)] rounded-sm p-5 space-y-6">
            ...
            <div className="space-y-4">
              <VitalItem icon={TrendingUp} label="Growth Index" value={`${growth.toFixed(1)}%`} color={growth >= 0 ? "text-emerald-500" : "text-rose-500"} />
              <VitalItem icon={Globe} label="Wallet Nodes" value={wallets.length} color="text-indigo-500" />
