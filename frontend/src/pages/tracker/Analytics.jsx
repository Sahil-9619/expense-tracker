  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-8">
        <div>
          <h3 className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.5em] mb-2">Protocol Analysis</h3>
          <h4 className="text-2xl font-black text-white tracking-tighter uppercase">System Performance</h4>
        </div>
